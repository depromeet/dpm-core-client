// FIXME 1.5 MVP 초대 범위 고정
export const FormRange = () => {
	return (
		<div className="flex flex-col gap-2">
			<div className="h-5 flex items-center text-label-subtle text-body2 font-semibold">
				정산서 초대 범위
			</div>
			<div className="h-12 px-4 rounded-lg border border-line-normal flex items-center gap-1">
