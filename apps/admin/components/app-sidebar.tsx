											...
											<Link href={item.href} className="flex flex-col gap-2 lg:flex-row lg:gap-3">
												...
												<span
													className={cn(
														...
														active ? 'text-label-normal' : 'text-label-subtle',
													)}
												>
													{item.title}
												</span>
