		...
		<div className="max-w-lg mx-auto fixed bottom-0 z-9999 relative bg-white">
			<div className="px-5 pt-[30px] pb-5 rounded-t-[20px] flex flex-col gap-8">
				<div className="flex flex-col gap-3 ">
					...
					<ul className="flex flex-col text-body2 font-medium text-gray-600">
						<li>
							- <span className="text-red-500">멤버 확정 후에는 참석 여부를 수정</span>할 수
							없습니다.
						</li>
						<li>- 수정이 필요한 경우, 정산서를 삭제하고 새로 만들어야 합니다.</li>
						<li>- 확정 전에는 꼭 한 번 더 확인해 주세요.</li>
					</ul>
				</div>
				<div className="flex items-center gap-2">
					...
					<button
						type="button"
						className="flex-1 h-12 bg-red-400 rounded-lg flex items-center justify-center text-body1 text-white font-semibold"
					>
						확정하기
					</button>
				</div>
