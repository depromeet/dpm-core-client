			...
			<div className="flex items-center justify-center flex-col gap-8">
				...
				<div className="flex flex-col items-center gap-[22px]">
					<div className="flex flex-col gap-4  text-center">
						<h1 className="text-title1 font-bold text-gray-800">참여 여부 제출 링크 생성됨</h1>
						<p className="text-gray-500 text-body2 font-medium">
							멤버들이 참석 여부를 제출할 수 있도록 <br /> 링크를 복사해 공유해 주세요.
						</p>
					</div>
					<button
						type="button"
						className="px-4 py-3 rounded-lg cursor-pointer bg-gray-100 gap-[6px] flex items-center justify-center text-body2 font-semibold text-gray-700"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="15"
