...
const STATUS_MAP = {
	PRESENT: {
		icon: <CircleCheck fill="#5E83FE" size={20} color="#fff" />,
		label: '출석',
	},
	ABSENT: {
		icon: <CircleX fill="#FF7070" size={20} color="#fff" />,
		label: '결석',
	},
	LATE: {
		icon: <CircleMinus fill="#FFC06E" size={20} color="#fff" />,
		label: '지각',
	},
	EXCUSED_ABSENT: {
		icon: <CircleMinus fill="#3EA32C" size={20} color="#fff" />,
		label: '인정',
	},
};

export const AttendanceStatusLabel = ({ status }: AttendanceStatusProps) => {
