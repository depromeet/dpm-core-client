...
export const AfterPartyAttendeesFilter = () => {
	const {
		afterPartyAttendeesStatus,
		afterPartyAttendeesIsMyTeam,
		handleChangeSAfterPartyAttendeesStatus,
		handleChangeAfterPartyAttendeesIsMyTeam,
	...
	return (
		<div className="flex items-center justify-between">
			<ToggleGroup
				...
				value={afterPartyAttendeesStatus}
				onValueChange={handleChangeSAfterPartyAttendeesStatus}
			>
				<ToggleGroupItem
					className={cn(
			...
			{user?.teamNumber && (
				<div className="flex items-center gap-1.5">
					<Checkbox
						...
						checked={afterPartyAttendeesIsMyTeam}
						onCheckedChange={handleChangeAfterPartyAttendeesIsMyTeam}
					/>
					<Label
						htmlFor="isMyTeam"
