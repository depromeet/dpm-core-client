			...
			<div className="relative inline-flex">
				{showTooltip && (
					<div className="absolute bottom-[calc(100%+8px)] left-0 flex items-center justify-center rounded-lg bg-background-inverse px-2 py-1.5">
						...
						<div
							className="-bottom-1.25 absolute left-4 h-1.25 w-[11.5px] bg-background-inverse"
				...
				<button
					...
					disabled={isRead}
					className={cn(
						'flex h-10 items-center gap-1.5 overflow-hidden rounded-[38px] border px-4 font-semibold text-body3 tracking-tight',
						isRead
							? 'border-primary-normal bg-primary-extralight text-primary-normal'
							: 'border-line-normal bg-comp-fill-white text-label-alternative',
					)}
				>
